...
> ## 사용자의 입장으로 바라보는 개발자
개발의 목적은 단순 기능 구현이 아니라, 사용자의 문제를 해결하는 일이라고 생각합니다.  
항상 사용자의 입장에서 고민하고, 사용자가 만족할 수 있는 결과물을 만드려 노력합니다.
- **Java 기반의 개발자**로서, 사용자 경험 중심의 프로그램을 다수 개발한 경험이 있습니다.
- 개발의 모든 과정에서 1순위 고려사항은 언제나 **사용자의 만족도**입니다.
- 화려한 기능보다, 사용자에게 가치 있는 경험을 제공하는 개발을 지향합니다.
...
- 음식 선택 시 칼로리·영양소 자동 계산 및 UI에 반영되도록 구현
...
- 메뉴·장바구니·주문데이터를 동적으로 관리할 수 있는 구조 설계
